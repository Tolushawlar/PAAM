...
const Sidebar = ({ userType, onToggle }) => {
  ...
  const adminMenuItems = [
    ...
    { icon: contentIcon, iconB: contentIconB, label: "Prayer Focus", path: "/admin/PrayerFocusManagement" },
    { icon: contentIcon, iconB: contentIconB, label: "Verse of the Day", path: "/admin/VerseOfTheDayManagement" },
    { icon: contentIcon, iconB: contentIconB, label: "Devotionals", path: "/admin/DevotionalManagement" },
    { icon: examinationIcon, iconB: examinationIconB, label: "Course Completion", path: "/admin/CourseCompletionManagement" },
    { icon: memberIcon, iconB: memberIconB, label: "Community Spotlight", path: "/admin/CommunitySpotlightManagement" },
    { icon: contentIcon, iconB: contentIconB, label: "Resources", path: "/admin/ResourcesManagement" },
    { icon: streamingIcon, iconB: streamingIconB, label: "Videos", path: "/admin/VideosManagement" },
