...
const CoordinatorAIChat = () => {
  const { t } = useTranslation();
  const [messages, setMessages] = useState([
    {
      id: 1,
      text: "Hello! I'm your AI assistant for coordinators. How can I help you manage your groups today?",
      sender: 'ai',
      timestamp: new Date()
    }
  ]);
  ...
  const generateAIResponse = (userInput) => {
    const responses = [
      "As a coordinator, I can help you with member management and group coordination.",
      "I can assist you with meeting planning and member engagement strategies.",
      "Let me help you with coordination tasks and member support.",
      "I'm here to support your coordination efforts and group management needs.",
      "I can provide guidance on effective coordination and leadership practices."
    ];
...
export default CoordinatorAIChat;