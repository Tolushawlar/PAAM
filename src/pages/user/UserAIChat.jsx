...
const UserAIChat = () => {
  ...
  const generateAIResponse = (userInput) => {
    const responses = [
      ...
      "I'm here to assist you. Based on your message, I'd recommend...",
      "Thank you for reaching out. I can help you with information about PAAM programs.",
      "I'd be happy to help you with that. Let me provide you with some guidance."
    ];
